...
const DonorLeaderboard: React.FC<DonorLeaderboardProps> = ({ 
    ...
    if (leaderboard.length === 0) {
        return (
            <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Top Donors</h2>
                        ...
                        >
                            ...
                            <div className="flex-shrink-0">
                                {entry.donorAvatar ? (
                                    ...
                                    <div className="h-12 w-12 rounded-full bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center text-white font-bold text-lg shadow">
                            ...
                            <div className="flex-shrink-0 text-right">
                                <div className={`px-4 py-2 rounded-lg ${
                                    ...
                                    <div className="text-xl font-bold">{entry.deliveredItems}</div>
                                </div>
                            </div>
                        </div>
                    );
            ...
            {user && user.role === 'donor' && showUserPosition && !userEntry && (
                <div className="mt-6 pt-6 border-t border-gray-200">
                    {loadingUserPosition ? (
                        ...
                        <div className="flex items-center gap-4 p-4 rounded-lg border-2 border-teal-500 bg-teal-50">
                            <div className="flex-shrink-0">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                    <h3 className="font-semibold text-lg text-teal-700">Your Position</h3>
                                    <span className="px-2 py-0.5 bg-teal-500 text-white text-xs font-medium rounded-full">
                                        You
                                    </span>
                                </div>
